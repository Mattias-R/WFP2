...
for device in excelrange:
    ...
    for i in range(maxLines):
        ...
        if(tableName[i-1].value == "NA"):
            ...
            value.append(difference)
        #if value is 0, that means the customer is proably on holidy
        #if we do not pop it, the allowed difference would be too low and more false positive apppear
        ...
        #if difference is greater then durchschnitt + abweichung * 2 for 3 days in a row, we concider it as an anomaly
